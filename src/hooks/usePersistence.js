...
export const usePersistence = (state, stateSetters, resetInProgressRef = null, importInProgressRef = null) => {
  ...
  }, [contacts, orgcharts, contactFolders, orgchartFolders, excelPath, excelVersion, selectedOrgChart, expandedFolders, expandedSections, displayFieldsByOrgChart]);

  /**
   * Chargement au démarrage + listeners fermeture
   */
  useEffect(() => {
    loadAllData();

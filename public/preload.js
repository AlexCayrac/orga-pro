...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  findPhotoForContact: async (firstName, lastName, matricule) => {
    const res = await ipcRenderer.invoke('find-photo-for-contact', firstName, lastName, matricule);
    if (res && res.success && res.found && res.dataUrl) return res.dataUrl;
    return null;
  },
